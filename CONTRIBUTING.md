...
- [Issues](https://github.com/TumulusSoftware/TumulusAPI/issues)
...
[GitHub issues](https://github.com/TumulusSoftware/TumulusAPI/issues). However, if
...
There are 3 types of issues (each with their own corresponding [label](https://github.com/TumulusSoftware/TumulusAPI/labels)):
...
1. Fork the [TumulusAPI](https://github.com/TumulusSoftware/TumulusAPI) repo

Go to the [project](https://github.com/TumulusSoftware/TumulusAPI) page then hit the `Fork`
...
```sh
$ git clone https://github.com/$your_github_account/TumulusAPI.git   
```
3. Add an `upstream` remote to keep your fork in sync with the main repo.
```sh
$ cd TumulusAPI
$ git remote add upstream https://github.com/TumulusSoftware/TumulusAPI.git
$ git remote -v

origin  https://github.com/$your_github_account/TumulusAPI.git (fetch)
origin  https://github.com/$your_github_account/TumulusAPI.git (push)
upstream        https://github.com/TumulusSoftware/TumulusAPI.git (fetch)
upstream        https://github.com/TumulusSoftware/TumulusAPI.git (push)
```
